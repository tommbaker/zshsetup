...
alias lt="eza --tree"               # directory tree
alias tree="eza --tree"             # same as lt

# bat — type: cat <file>  or  less <file>
if command -v batcat >/dev/null; then
  alias bat="batcat"                # Debian/Ubuntu ships bat as batcat
fi
alias cat="bat --paging=never"      # syntax-highlighted output, no pager
